...
export const AddPost = () => {
  ...
  return (
    <Paper style={{ padding: 30 }} className={styles.root}>
      <Button onClick={() => inputFileRef.current.click()} className={styles.button} variant="outlined" size="large">
        Завантажити превью
      </Button>
      <input ref={inputFileRef} type="file" onChange={handleChangeFile} hidden />
      {imageUrl && (
        <>
          <Button variant="contained" color="error" onClick={onClickRemoveImage} className={styles.button}>
            Видалити
          </Button>
          <img
